 ...
 */
const CONFIG = {
    // New Webhook for Beta Application
    FORM_WEBHOOK: 'https://joshtsang0916.zeabur.app/webhook/ChooseMe',
    // Existing Chat Webhook
    CHAT_WEBHOOK: 'https://joshtsang0916.zeabur.app/webhook/687f1da6-66f0-4450-901f-b450bb5db667/chat'
};

// =========================================================================
// 1. Circuit Board Animation (Tech Flow) - Same as index.html
// =========================================================================
...
// =========================================================================
// 3. n8n Chat Integration (Same as original)
// =========================================================================
(function () {
    createChat({
